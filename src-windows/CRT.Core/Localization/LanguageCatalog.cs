...
public static class LanguageCatalog
{
    private static readonly Dictionary<string, string> English = new()
    {
        ...
        ["Classic Mode Description"] = "Time a run as start + end with loads subtracted, instead of as segments.",
        ...
        ["Start"] = "Start",
        ["End"] = "End",
        ["No segments"] = "No segments yet. Use Add Segment, or mark them on the Video Retimer.",
        ["Rewind"] = "Rewind (Ctrl+Left)",
        ["Fast Forward"] = "Fast forward (Ctrl+Right)",
        ["Playback Speed"] = "Playback speed",
        ["In-Video Timer"] = "In-Video Timer",
        ["Preset"] = "Preset",
        ["Timer Format"] = "Timer Format",
        ["Timer Format Hint"] = "Placeholders: {time_without_loads}, {time_with_loads}. Other text is shown as written; a new line stacks another row.",
        ["Clock Style"] = "Clock Style",
        ["Clock Style Hint"] = "Compact shows only the units needed and grows as the run does. Fitted keeps one width for the whole run. Full is always HH:MM:SS.mmm.",
        ["Clock Compact"] = "Compact  -  1.000 / 10.000 / 1:00.000",
        ["Clock Fitted"] = "Fitted  -  0:01.000 / 0:10.000 / 1:00.000",
        ["Clock Full"] = "Full  -  00:00:01.000",
        ...
        ["General"] = "General",
        ["Timing"] = "Timing",
        ["Timer Content"] = "What it shows",
        ["Timer Text"] = "Text",
        ["Timer Background Section"] = "Background",
        ["Timer Placement"] = "Placement",
        ["Tools"] = "Tools",
        ["Outline"] = "Outline",
        ...
        ["Timer Preview"] = "Timer Preview",
        ["Timer Preview Caption"] = "A five-minute run with a fifteen-second load, sampled at 1:35. Shown on black and on white, because a burned-in timer has to stay readable over both.",
        ["Preview Failed"] = "The preview could not be rendered.",
        ["Text Color"] = "Text Color",
        ["Timer Background"] = "Draw a background behind the timer",
        ["Background Color"] = "Background Color",
        ["Background Opacity"] = "Background Opacity",
        ["Pick"] = "Pick",
        ["Video Missing"] = "The video for this run could not be found:",
        ["Video Reopened"] = "Reopened the video saved with this run.",
